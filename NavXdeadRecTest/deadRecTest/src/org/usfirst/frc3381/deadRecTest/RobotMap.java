...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveSystemleftSideEncode = new Encoder(0, 1, true, EncodingType.k4X);
        LiveWindow.addSensor("driveSystem", "leftSideEncode", driveSystemleftSideEncode);
        driveSystemleftSideEncode.setDistancePerPulse(0.013125);
        driveSystemleftSideEncode.setPIDSourceType(PIDSourceType.kDisplacement);
        driveSystemrightSideEncode = new Encoder(2, 3, false, EncodingType.k4X);
