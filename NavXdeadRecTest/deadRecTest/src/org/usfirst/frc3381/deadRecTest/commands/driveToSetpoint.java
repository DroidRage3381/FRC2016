...
public class driveToSetpoint extends PIDCommand {
	...
	public driveToSetpoint() {
        ...
        super("driveToSetpoint", 0.01, 0.001, 0.010, 0.02);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SOURCE
		 */
		double leftEncoder = RobotMap.driveSystemleftSideEncode.pidGet();
		double rightEncoder = RobotMap.driveSystemrightSideEncode.pidGet();
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=OUTPUT
		 */
		RobotMap.driveSystemleft0.pidWrite(-output);
		RobotMap.driveSystemleft1.pidWrite(-output);
