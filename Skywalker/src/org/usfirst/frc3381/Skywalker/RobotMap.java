...
public class RobotMap {
    ...
    public static AnalogPotentiometer lifterArmlengthPotA0;
   ...
   public static AHRS ahrs;
    ...
    public static void init() {
        ...
        lifterArmlengthPotA0 = new AnalogPotentiometer(0, 1.0, 0.0);
        LiveWindow.addSensor("lifterArm", "lengthPotA0", lifterArmlengthPotA0);
