...
public class lifterArm extends Subsystem {
    ...
    private final DigitalInput fullExtentionSwitch2 = RobotMap.lifterArmfullExtentionSwitch2;
    private final DigitalInput fullRetractionSwitch3 = RobotMap.lifterArmfullRetractionSwitch3;
    private final DigitalInput encoderResetSwitch4 = RobotMap.lifterArmencoderResetSwitch4;
    ...
    */
    public boolean isAtFullExtention() {
    	return !Robot.lifterArm.fullExtentionSwitch2.get();
    }
    public boolean isAtFullRetraction() {
    	return !Robot.lifterArm.fullRetractionSwitch3.get();
    }
    public boolean isAtBottomSwitch() {
    	return !Robot.lifterArm.encoderResetSwitch4.get();
    }
}
