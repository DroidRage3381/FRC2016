...
public class shooter extends Subsystem {
    ...
    private final SpeedController launcherMotor6 = RobotMap.shooterlauncherMotor6;
    private final SpeedController feederMotor7 = RobotMap.shooterfeederMotor7;
    ...
    public void runLauncher(double speed) {
    	launcherMotor6.set(speed);
    }
    
    public void runFeeder(double speed) {
    	feederMotor7.set(-speed);
    }
}
