...
public class autoStraight extends PIDCommand {
    ...
    protected void initialize() {
    	Robot.resetEncoders();
    	Preferences pref = Robot.pref;
    	driveStraight = pref.getDouble("Distance to Drive", 60);
    	tolerance = 1.0;
    }
    ...
    protected void execute() {
    	...
    	P = pref.getDouble("P Distance", 0.02);
    	I = pref.getDouble("I Distance", 0);
    	D = pref.getDouble("D Distance", 0);
    	getPIDController().setPID(P, I, D);
    	SmartDashboard.putNumber("Current P:", P);
    	SmartDashboard.putNumber("Current I:", I);
    	SmartDashboard.putNumber("Current D:", D);
    	SmartDashboard.putNumber("Right Encoder", Robot.driveSystem.getPositionLeft());
    	SmartDashboard.putNumber("Current Error", getPIDController().getError());
    }
