...
public class driveToSetpoint extends PIDCommand {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        super("driveToSetpoint", 0.01, 0.001, 0.001, 0.02);
    ...
    protected double returnPIDInput() {
        ...
        return RobotMap.driveSystempositionFeedback.pidGet();
    ...
    protected void usePIDOutput(double output) {
        ...
        RobotMap.driveSystemwindowMotor.pidWrite(output);
    ...
    protected void execute() {
    	...
    	SmartDashboard.putNumber("Current Distance", windowPosition);
    ...
    protected void end() {
    	Robot.driveSystem.setWindowSpeed(0);
    }
